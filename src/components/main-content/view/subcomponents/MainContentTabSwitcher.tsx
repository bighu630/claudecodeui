import { MessageSquare, Terminal, Folder, GitBranch, ClipboardCheck, PanelLeft, type LucideIcon } from 'lucide-react';
...
const BASE_TABS: BuiltInTab[] = [
  ...
  { kind: 'builtin', id: 'session-panel', labelKey: 'tabs.session', icon: PanelLeft },
];
