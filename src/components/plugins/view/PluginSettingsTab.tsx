...
const STARTER_PLUGIN_URL = 'https://github.com/codeagent-ui/codeagent-plugin-starter';
const TERMINAL_PLUGIN_URL = 'https://github.com/codeagent-ui/codeagent-plugin-terminal';
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex min-w-0 items-center gap-2.5">
            ...
            <div className="min-w-0">
              ...
              >
                <GitBranch className="h-3 w-3" />
                codeagent-ui/codeagent-plugin-starter
              </a>
            </div>
          </div>
          <button
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex min-w-0 items-center gap-2.5">
            ...
            <div className="min-w-0">
              ...
              >
                <GitBranch className="h-3 w-3" />
                codeagent-ui/codeagent-plugin-terminal
              </a>
            </div>
          </div>
          <button
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-center gap-3 border-t border-border/50 pt-2">
        ...
        <span className="text-muted-foreground/20">·</span>
        <a
          href="https://github.com/bighu630/claudecodeui"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-1 text-xs text-muted-foreground/60 transition-colors hover:text-foreground"
        >
