# Contributing to CodeAgent UI

Thanks for your interest in contributing to CodeAgent UI! Before you start, please take a moment to read through this guide.

## Before You Start

- **Search first.** Check [existing issues](https://github.com/bighu630/claudecodeui/issues) and [pull requests](https://github.com/bighu630/claudecodeui/pulls) to avoid duplicating work.
- **Discuss first** for new features. Open an [issue](https://github.com/bighu630/claudecodeui/issues/new) to discuss your idea before investing time in implementation. We may already have plans or opinions on how it should work.
